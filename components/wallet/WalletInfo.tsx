...
export const WalletInfo: React.FC = () => {
  ...
  const networkName = 'Tezos';

  const balance = walletBalance.toFixed(4);
  const isLoading = false;

  return (
    <Card className="min-w-[200px] border border-blue-500/10 !bg-black/40 backdrop-blur-md">
      <div className="space-y-2">
        ...
        <div className="pt-2 border-t border-white/5">
          ...
          <div className="flex items-center gap-2">
            <p className="text-blue-400 font-bold text-lg font-mono drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]">
